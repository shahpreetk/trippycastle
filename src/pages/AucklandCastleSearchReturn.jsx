...
import "./AucklandCastleSearchReturn.css";
import axios from "axios";

const AucklandCastleSearchReturn = () => {
    ...
    useEffect(() => {
        axios.get("/97be7c80a79d4d89b953502b8bbdc9ae").then((response) => {
...
export default AucklandCastleSearchReturn;